...
_SessionToolRunner_requestOptions = function _SessionToolRunner_requestOptions2() {
  ...
  return {
    ...
    headers: buildHeaders([{ "x-stainless-helper": HELPER_NAME }, (_a2 = __classPrivateFieldGet(this, _SessionToolRunner_requestOpts, "f")) == null ? void 0 : _a2.headers]),
    ...
    while (index < fallbacks.length - 1) {
      ...
      res = await next({
        ...
        body: JSON.stringify({
          ...body,
          ...entry,
          ...((_c = message.stop_details) == null ? void 0 : _c.fallback_credit_token) ? { fallback_credit_token: message.stop_details.fallback_credit_token } : void 0
        })
      });
    }
